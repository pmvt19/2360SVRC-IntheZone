...
#pragma config(Sensor, in3,    fourPot,        sensorPotentiometer)
...
#pragma config(Motor,  port10,          rightWheel,    tmotorVex393HighSpeed_HBridge, openLoop, driveRight, encoderPort, I2C_2)
